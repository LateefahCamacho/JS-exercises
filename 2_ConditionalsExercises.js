...
function exercise1(num1) {
  ...
  function exercise4(varA, varB) {
    ...
    // Write your code for the exercise below here:
    // --------------------------------------------
    if(varA === "string" || "number" && varB === varA){
  ...
  // consider other data types beside strings and variables.
   // VarA and VarB seemed equal when comparing an integer of the same value ie (4,5)
  ...
  function exercise8(amount1, amount2, minimum, maximum) {
    ...
    if(amount1 < maximum && amount1 >minimum &&
        amount2 < maximum && amount2 > minimum){
      answer8 = true;
      } else {
        answer8 = false;
      }
  ...
  function exercise10(num10) {
    ...
    // Write your code for the exercise below here:
    // --------------------------------------------
    for(let num10 = 0; num10 < 100; num10 = num10 + 1)
    if(num10 % 15 === 0) {
     answer10 = "Fizz";
    }else if(num10 % 5 === 0) {
     answer10 = "Buzz";
  ...
  //Ah yes I made it! It was a challenge, its a great way to use some references like MDN docs.
